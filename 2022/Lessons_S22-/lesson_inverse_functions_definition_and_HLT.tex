...
\begin{document}
{\bf \large Lesson \arabic{lesson_inverse_functions_definition_and_HLT}: Inverse Functions - Definition and the HLT}\phantomsection\label{les:inverse_functions_definition_and_HLT}
