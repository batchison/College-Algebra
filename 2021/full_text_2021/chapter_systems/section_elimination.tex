...
\begin{document}
\section{The Addition Elimination Method (L\arabic{lesson_elimination})}
...
%$$x - 4 y = 8\qquad\qquad 5 x + 4 y = - 24$$
\begin{eqnarray*}
x - 4 y = 8 & & 5 x + 4 y = - 24\\
& & \\
    \begin{array}{l}
...
\begin{eqnarray*}
  ...
  \end{eqnarray*}
\end{example}
As we get started, it is important for each problem that all variables and constants are aligned before we begin multiplying and adding equations. This is illustrated in the next example which includes the five steps we will go through to solve a problem using elimination.
\begin{center}
\begin{tabular}{|l|l|}
  \hline
...
\end{tabular}
\end{center}
Just as with graphing and substitution, it is possible to have no solution or infinitely many solutions with elimination. If the variables all disappear from our problem, a true statement will always indicate infinitely many solutions and a false statement will always indicate no solutions.
\begin{example}~~~Solve the following system of equations.
  \begin{eqnarray*}
